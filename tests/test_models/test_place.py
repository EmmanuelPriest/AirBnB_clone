...
class TestPlace_instantiation(unittest.TestCase):
    '''Unittests for the instantiation of the class Place'''
    ...
    def test_str_representation(self):
        ...
        place = Place()
        place.id = "123456"
        place.created_at = place.updated_at = dtime
        place_str = place.__str__()
        self.assertIn("[Place] (123456)", place_str)
        self.assertIn("'id': '123456'", place_str)
        self.assertIn("'created_at': " + dtime_repr, place_str)
        self.assertIn("'updated_at': " + dtime_repr, place_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        place = Place(id="345", created_at=dtime_iso, updated_at=dtime_iso)
        self.assertEqual(place.id, "345")
        self.assertEqual(place.created_at, dtime)
        self.assertEqual(place.updated_at, dtime)
...
class TestPlace_save(unittest.TestCase):
    '''Unittests for the save method of the class Place'''
...
class TestPlace_to_dict(unittest.TestCase):
    '''Unittests for the to_dict method of the class Place'''
    ...
    def test_to_dict_output(self):
        ...
        self.assertDictEqual(place.to_dict(), time_dict)
