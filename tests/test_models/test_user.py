...
class TestUser_instantiation(unittest.TestCase):
    '''Unittests for the instantiation of the class User'''
    ...
    def test_str_representation(self):
        ...
        user = User()
        user.id = "123456"
        user.created_at = user.updated_at = dtime
        user_str = user.__str__()
        self.assertIn("[User] (123456)", user_str)
        self.assertIn("'id': '123456'", user_str)
        self.assertIn("'created_at': " + dtime_repr, user_str)
        self.assertIn("'updated_at': " + dtime_repr, user_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        user = User(id="345", created_at=dtime_iso, updated_at=dtime_iso)
        self.assertEqual(user.id, "345")
        self.assertEqual(user.created_at, dtime)
        self.assertEqual(user.updated_at, dtime)
...
class TestUser_save(unittest.TestCase):
    '''Unittests for the save method of the class User'''
...
class TestUser_to_dict(unittest.TestCase):
    '''Unittests for the to_dict method of the class User'''
    ...
    def test_to_dict_output(self):
        ...
        self.assertDictEqual(user.to_dict(), time_dict)
