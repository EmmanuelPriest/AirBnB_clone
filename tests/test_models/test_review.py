...
class TestReview_instantiation(unittest.TestCase):
    '''Unittests for the instantiation of the class Review'''
    ...
    def test_str_representation(self):
        ...
        review = Review()
        review.id = "123456"
        review.created_at = review.updated_at = dtime
        review_str = review.__str__()
        self.assertIn("[Review] (123456)", review_str)
        self.assertIn("'id': '123456'", review_str)
        self.assertIn("'created_at': " + dtime_repr, review_str)
        self.assertIn("'updated_at': " + dtime_repr, review_str)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        review = Review(id="345", created_at=dtime_iso, updated_at=dtime_iso)
        self.assertEqual(review.id, "345")
        self.assertEqual(review.created_at, dtime)
        self.assertEqual(review.updated_at, dtime)
...
class TestReview_save(unittest.TestCase):
    '''Unittests for the save method of the class Review'''
...
class TestReview_to_dict(unittest.TestCase):
    '''Unittests for the to_dict method of the class Review'''
    ...
    def test_to_dict_output(self):
        ...
        self.assertDictEqual(review.to_dict(), time_dict)
