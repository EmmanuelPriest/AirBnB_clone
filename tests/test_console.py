...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_quit(self):
        holb = "Quit command to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help quit"))
            self.assertEqual(holb, output.getvalue().strip())

    def test_help_create(self):
        holb = ("Usage: create <class>\n        "
    ...
    def test_help_EOF(self):
        holb = "EOF signal to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))
            self.assertEqual(holb, output.getvalue().strip())

    def test_help_show(self):
        holb = ("Usage: show <class> <id> or <class>.show(<id>)\n        "
    ...
    def test_help_all(self):
        holb = ("Usage: all or all <class> or <class>.all()\n        "
                "Display string representations of all instances"
                " of a given class"
                ".\n        If no class is specified, displays"
                " all instantiated "
                "objects.")
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_help_count(self):
        holb = ("Usage: count <class> or <class>.count()\n        "
    ...
    def test_help(self):
        holb = ("Documented commands (type help <topic>):\n"
                "========================================\n"
